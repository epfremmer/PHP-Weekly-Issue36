...
namespace PHPWeekly\Issue36\Tests\Context\Traits;

use Behat\Behat\Hook\Scope\BeforeScenarioScope;
use Behat\Testwork\Hook\Scope\AfterSuiteScope;
use PHPWeekly\Issue36\Tests\CodeCoverage;

/**
 * Class CodeCoverageTrait
 *
 * @package PHPWeekly\Issue36\Tests\Context\Traits
 */
trait CodeCoverageTrait
{
    ...
    {
        self::$coverage = self::$coverage ?: new CodeCoverage();
    }
